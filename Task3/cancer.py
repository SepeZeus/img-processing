...
img = mpimg.imread('Task3/Fig3.04(a).jpg')
...
# Contrast stretching
p2, p98 = np.percentile(img, (12, 92))
#print(p2, p98)
...
y = 0.27#25 or 0 = black img, low values brings black and red curves closer together
c = 0.84 # seems to work similarly to y, except that I could not detect visual change
...
#Negative seems to give the "best" results